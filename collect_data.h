...
// class CCOLLECTDATA : public CBuzzLoopFunctions {
class CCollectData : public CLoopFunctions {

public:
   virtual void Init(TConfigurationNode& t_tree) override;
   virtual void Reset() override;
   virtual void Destroy() override;
   virtual void PostStep() override; // Executes user-defined logic right after a control step is executed.
